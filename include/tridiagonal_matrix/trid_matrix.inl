...
// Overloaded constructor that takes the size of the matrix "n" and fixed initial value "val" for all elements of dl_, d_ and
// du_
template<typename T>
...
// Overloaded constructor that takes the size of the matrix "n" and a seed value for random initial values of all elements of
// dl_, d_ and du_
template<typename T>
